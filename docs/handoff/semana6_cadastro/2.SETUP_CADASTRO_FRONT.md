...
Antes de copiar o código, garanta que a biblioteca de calendário/hora esteja instalada no seu ambiente rodando este comando no terminal:
...
Abaixo está a arquitetura completa das abas do sistema. Note a inclusão estratégica de `tabBarStyle: { display: 'none' }` especificamente para a tela "add" e a limpeza completa de imports não utilizados para evitar erros de compilação.
...
export default function AddScreen() {
  ...
  const unitMap: Record<string, string> = {
    "Comprimido": "unid", "Cápsula": "unid", "Gotas": "unid", "Xarope": "unid", "Injeção": "unid", "Outros": "" 
  }

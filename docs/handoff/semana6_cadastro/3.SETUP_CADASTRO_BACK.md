...
Abaixo está o arquivo de cadastro definitivo em sua versão mais pura e sem abreviações. Cada Hook, Validação e gravação `addDoc` está devidamente implementado.
